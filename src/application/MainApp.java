...
public class MainApp extends Application {
    ...
    public MainApp() {
        ...
        //gio
        String[] extMidi = {".mid",".midi"};
        fileData.add(new FileType("File Midi",".mid",extMidi));
        String[] extDna = {".dna",".dnaType1",".dnaType2"};
        fileData.add(new FileType("File di Dna",".dna",extDna));
    }
     ...
     */
    public boolean showPersonEditDialog(FileType file) {
        try {
